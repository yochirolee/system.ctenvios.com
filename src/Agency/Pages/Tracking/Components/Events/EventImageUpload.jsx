...
export const EventImageUpload = ({ imageUrl, setImageUrl }) => {
	...
	const uploadExcelFile = async (file) => {
		try {
			const response = await apiTracking.events.uploadImage(file, setUploadProgress);
				...
				<div>
					...
					>
						<div className=" text-center">
							...
							<p className="text-xs text-gray-500">
								Click to upload Images &#40;Image should be under 2 MB &#41;
							</p>
						</div>
					</label>
