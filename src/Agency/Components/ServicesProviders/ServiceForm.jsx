...
import { useFetchProductsCategories } from "../../Hooks/useProductsCategories";
import { CheckBoxesProductsCategories } from "../ProductsCategories/checkBoxesProductsCategories";
...
export default function ServiceForm({ setIsOpen, selectedProvider, isEditing = false }) {
	const {
		register,
		handleSubmit,
		reset,
