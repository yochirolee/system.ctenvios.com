...
export default function ServicePriceForm({
	...
	console.log(servicePrice, "servicePr");
	...
	const onSubmit = (data) => {
		...
		data.packageCategoryId = parseInt(data.packageCategoryId);
					...
					{selectedService && (
						<div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
							<div className="sm:col-span-3">
								...
								<div className="mt-2">
									<select
										{...register("packageCategoryId", { required: "La Categoria es Requerida" })}
										className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
									>
										<option value={null}>Seleccione una Categoria</option>
										{selectedService?.packagesCategories.map((category) => (
